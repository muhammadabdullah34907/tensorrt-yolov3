...
def add_camera_args(parser):
    ...
    parser.add_argument('--file', dest='use_file',
                        default=None,help='use a video file as input (remember to '
                        'also set --filename)',
                        action='store_true')
    parser.add_argument('--image', dest='use_image',
                        default=None, help='use an image file as input (remember to '
                        'also set --filename)',
                        action='store_true')
